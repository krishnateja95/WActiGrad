...
class LlamaAttention(nn.Module):
    ...
    def store_attn_weight_gradients(self):
        ...
        self.prune_API_MHSA_q.store_attn_weight_gradients(self.q_proj.weight, self.q_proj.weight.grad)
        ...
        self.prune_API_MHSA_o.store_FFN_weight_gradients(self.o_proj.weight, self.o_proj.weight.grad)
    ...
    def prune_attn_fc_layer(self, global_hidden_size_prune_mask):
        ...
        if self.prune_Head:
            ...
            attn_head_score = self.prune_API_MHSA_attn.get_head_act_score(**dict_args) if self.Attention_act_score else 0
...
class LlamaDecoderLayer(nn.Module):
    ...
    def initialize_pruning_functions(self):
        ...
        self.prune_API_MHSA_attn = PruneGPT_FFN_hidden_size(prune_dimension = self.hidden_size)
        self.prune_API_MLP_attn  = PruneGPT_FFN_hidden_size(prune_dimension = self.hidden_size)
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def prune_fc_layer(self):
        ...
        del global_hidden_size_prune_mask
